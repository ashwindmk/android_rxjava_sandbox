...
import com.ashwin.rxjavasandbox.databinding.ActivityReplaySubjectBinding;
...
public class ReplaySubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityReplaySubjectBinding binding = ActivityReplaySubjectBinding.inflate(getLayoutInflater());
        ...
        ReplaySubjectRepository replaySubjectRepository = new ReplaySubjectRepository();
        replaySubject = replaySubjectRepository.getReplaySubject();
    }
        ...
        replaySubject
                ...
                .subscribeWith(new Observer<Integer>() {
                    ...
                    public void onNext(@NonNull Integer integer) {
                        // Will get all replayed and live values.
